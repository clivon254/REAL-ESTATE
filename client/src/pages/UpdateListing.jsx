...
export default function UpdateListing() {
    ...
    const handleSubmit = async (e) => {
        ...
        try
        {
            ...
            {
                return setError('You must upload at least one one image')
            }

            if(+formData.regularPrice < +formData.discountPrice)
            {
                setError("Discount price must be lower than reqular price")
            }
            ...
            const res = await axios.put(`/api/listing/update-listing/${params.id}`,{
                ...formData,
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <div className="flex gap-4 ">
                        ...
                        <button 
                            ...
                            className="p-3 text-green-700 border border-green rounded uppercase hover:shadow-lg disabled:opacity-80"
                        >
                                ...
                                >
                                    <img 
                                     ...
                                     <button 
                                        ...
                                        className="p-3 text-red-700 rounded-lg uppercase hover:opacit-75"
                                    >
                                        Delete
                                     </button>
